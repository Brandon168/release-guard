...
export const demoScenarios: DemoScenario[] = [
  ...
  {
    id: 'terraform-sg-tightening',
    title: 'Terraform plan: prod ingress tightening',
    subtitle: 'High-risk network control change with broad blast radius.',
    sourceLabel: 'infra/live/prod/network/app-sg.tfplan',
    sourceKind: 'Terraform Plan',
    artifactType: 'terraform_plan',
    artifactText: [
      '# module.app_sg.aws_security_group_rule.ingress_https will be replaced',
      '- cidr_blocks     = ["10.0.0.0/8"]',
      '+ security_groups = ["sg-alb-prod", "sg-bastion-prod"]',
      'Plan: 2 to change, 0 to add, 0 to destroy',
      'Applies to prod app subnet in us-east-1',
    ].join('\n'),
    fixture: requireFixture('security-group-tightening'),
  },
  {
